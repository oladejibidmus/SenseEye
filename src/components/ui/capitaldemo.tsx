        ...
        <Card className="overflow-hidden shadow-2xl border-0 rounded-2xl bg-white">
          <CardContent className="p-0">
            <div className="relative aspect-video bg-gray-900 rounded-2xl overflow-hidden">
              {!hasError ? <>
                  {/* Video Element */}
                  <video className="w-full h-full object-cover" poster="https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=800&h=450&fit=crop" onError={handleVideoError} controls={isPlaying} muted loop playsInline>
                ...
                opacity: 1
                      ...
                      <Button onClick={handlePlayPause} size="lg" className="w-20 h-20 rounded-full bg-[#FF6A1A] hover:bg-[#E55A0F] text-white shadow-2xl hover:scale-110 transition-all duration-300" aria-label="Play demo video">
                ...
                y: 0
                      ...
                      <Button onClick={handlePlayPause} variant="ghost" size="sm" className="text-white hover:bg-white/20" aria-label="Pause video">
            ...
            <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-[#FF6A1A]/10 to-[#1A2233]/10">
                  <div className="text-center p-8">
                    ...
                    <Button onClick={() => window.location.reload()} className="bg-[#FF6A1A] hover:bg-[#E55A0F] text-white">
                      Refresh Page
