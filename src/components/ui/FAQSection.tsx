      ...
      once: true
        ...
        <Accordion type="single" collapsible className="space-y-4">
          ...
          once: true
              ...
              <AccordionItem value={faq.id} className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-250 overflow-hidden">
