...
export const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background-primary">
      {/* Navigation */}
      <nav className="sticky top-0 z-50 bg-background-secondary/95 backdrop-blur-sm border-b border-border-subtle">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#testimonials" className="text-text-secondary hover:text-accent-primary transition-colors">Testimonials</a>
              <a href="#faq" className="text-text-secondary hover:text-accent-primary transition-colors">FAQ</a>
              <motion.button
                {...scaleOnHover}
                onClick={handleGetStarted}
                className="bg-accent-primary text-white px-6 py-2 rounded-lg font-medium hover:bg-accent-primary/90 transition-colors focus:outline-none focus:ring-2 focus:ring-accent-primary focus:ring-offset-2"
            ...
            <button
              ...
              className="md:hidden p-2 rounded-lg text-text-secondary hover:text-accent-primary hover:bg-background-tertiary transition-colors focus:outline-none focus:ring-2 focus:ring-accent-primary"
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="flex flex-col space-y-4">
                ...
                <button
                  onClick={handleGetStarted}
                  className="bg-accent-primary text-white px-6 py-2 rounded-lg font-medium hover:bg-accent-primary/90 transition-colors text-left focus:outline-none focus:ring-2 focus:ring-accent-primary focus:ring-offset-2"
                >
                  Get Started
                </button>
              </div>
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-background-secondary to-background-primary py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeInUp} className="text-center lg:text-left">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-text-primary leading-tight">
                Visual Field Testing
                <span className="text-accent-primary block">Reimagined</span>
              </h1>
              ...
              <p className="text-lg text-text-tertiary mt-4 leading-relaxed">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <motion.button
                  {...scaleOnHover}
                  onClick={handleGetStarted}
                  className="bg-accent-primary text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-accent-primary/90 transition-colors focus:outline-none focus:ring-2 focus:ring-accent-primary focus:ring-offset-2 flex items-center justify-center space-x-2"
                  aria-label="Get started with SenseEye"
                >
                ...
                <motion.button
                  {...scaleOnHover}
                  className="border-2 border-border-default text-text-primary px-8 py-4 rounded-lg font-semibold text-lg hover:border-accent-primary hover:text-accent-primary transition-colors focus:outline-none focus:ring-2 focus:ring-accent-primary focus:ring-offset-2 flex items-center justify-center space-x-2"
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative bg-gradient-to-br from-accent-primary to-accent-secondary rounded-2xl p-8 shadow-2xl">
                <div className="bg-background-secondary rounded-xl p-6">
                  ...
                  <div className="text-center mt-4">
                    ...
                    <p className="text-sm text-text-secondary">Fixation Point</p>
                  </div>
                </div>
                <div className="absolute -top-4 -right-4 w-16 h-16 bg-background-secondary rounded-full flex items-center justify-center shadow-lg">
          ...
          >
            {steps.map((step, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
                className="relative bg-background-primary rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow"
              >
                <div className="w-16 h-16 bg-accent-primary rounded-xl flex items-center justify-center mb-6 mx-auto">
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                ...
                variants={fadeInUp}
                whileHover={{ y: -5 }}
                className="bg-background-secondary rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-border-subtle"
              >
          ...
          >
            {testimonials.map((testimonial, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
                className="bg-background-primary rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow"
              >
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <button
                  ...
                  className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-background-tertiary transition-colors focus:outline-none focus:ring-2 focus:ring-accent-primary focus:ring-inset"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div {...fadeInUp}>
            ...
            <motion.button
              {...scaleOnHover}
              onClick={handleGetStarted}
              className="bg-white text-accent-primary px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-accent-primary inline-flex items-center space-x-2"
              aria-label="Get started with SenseEye"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="text-text-tertiary hover:text-accent-primary transition-colors focus:outline-none focus:ring-2 focus:ring-accent-primary rounded"
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-text-secondary">hello@senseeye.com</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Globe className="w-4 h-4 text-text-tertiary" />
                  <span className="text-text-secondary">www.senseeye.com</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-border-subtle mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-text-tertiary text-sm mt-2 md:mt-0">
              Built with <span className="text-accent-primary">♥</span> using Bolt.new
            </p>
          </div>
        </div>
      </footer>
